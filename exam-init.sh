...
wget -P /home/student/data http:///localhost/mock2/ansible.cfg  > /dev/null 2>&1
...
sudo -u student  wget -P /home/student/data http://content/Rhce/initialscripts.sh    > /dev/null 2>&1
